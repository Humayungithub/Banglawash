...
<html>
  <head>
    <title>Banglawash - Sign Up</title>
    ...
    <div class="registerContent">
      <div class="registerDiv">
        ...
        <form action="finishregister.php" method="post">
          ...
          <input type="text" id="citizenNo" name="citizenNumber" placeholder="Ex. 17101122">

          <label for="dob">Date of birth</label>
          <input type="date" id="dob" name="dateOfBirth" placeholder=""><br>

          <label for="mobileNo">Mobile Number</label>
          <input type="text" id="mobileNo" name="mobileNumber" placeholder="Ex. 1757152279">

          <label for="address">Address</label>
          <input type="address" id="address" name="address" placeholder="Mohakhali, Dhaka-1212, Bangladesh">

          <label for="mail">Email</label>
          <input type="text" id="mail" name="email" placeholder="Your Email">

          <label for="userid">Username</label>
          <input type="text" id="userid" name="userId" placeholder="Your Unique username">
