...
<html>
  <head>
    <title>BanglaWash - Checkout item</title>
             ...
             <?php
              ...
              ?>
                   <tr>
                      ...
                      <td><a href='checkcheckout.php?serviceId=<?=$row['serviceId']?>&memberId=<?=$row['memberId']?>&totalPrice=<?=$row['totalPrice']?>";'> <img src="assets/checkout.png" width="24" height="24"></a></td>
                  </tr>
  				<?php } ?>
